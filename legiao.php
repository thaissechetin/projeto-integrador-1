...
<main>
    ...
    <h1>Legião Urbana</h1>
        ...
        <p>A Legião Urbana surgiu no final de 1982 quando Renato Russo juntou-se a Marcelo Bonfá, Eduardo Paraná (Hoje, Kadu Lambach) e Paulo Guimarães (o `Paulista`). Em 1983, Paulista e Paraná saem e Dado Villa-Lobos assume a guitarra. Herbert Viana e Bi Ribeiro, este último ex-aluno de inglês de Renato em Brasília, integravam a banda Paralamas do Sucesso (que já estava no elenco da EMI-Odeon) e indicaram àquela gravadora a fita demo da nova banda de Brasília. Depois de a gravação chegar às mãos de executivos da EMI-Odeon, a Legião Urbana foi contratada e lançou seu primeiro álbum, em 1985, emplacando em junho daquele ano as canções “Será”, “Ainda é Cedo” e “Geração Coca-Cola”.</p>
            ...
            <p>
                ...
                coletânea com os maiores sucessos da banda.
                           ...
                           E os anos 90 foram definitivos para o Legião: Renato Russo, um dos maiores nomes da música brasileira e fundador da banda de rock Legião Urbana, nos deixou no dia 11 de outubro de 1996, aos 36 anos, após complicações decorrentes da Aids. Após sua morte, Dado Villa-Lobos e Marcelo Bonfá decidiram encerrar as atividades da banda.
            </p>

        <div id="slider">

            <div>
                <img src="imagens/legiao_dois (1) (1).jpg" alt="">
            </div>

            <div>
                <img src="imagens/as-quatro-estacoes.jpg" alt="">
            </div>

            <div>
                <img src="imagens/primeiro disco.jpg" alt="">
            </div>

            <div>
                <img src="imagens/a-tempestade-ou-o-livro-dos-dias.jpg" alt="">
            </div>
